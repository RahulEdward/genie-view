 ...
 * @param {Object} order - Order object to debug
 */
export const debugOrderCancellation = (order) => {
    ...
    const filled = parseFloat(order.filledqty || order.filled_quantity || 0);
 ...
 */
export const debugOrderList = (orders) => {
